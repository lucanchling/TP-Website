...
window.onload = function() {scrollFunction();plusDivs();sansfiltre();Trieprix();Triealpha}
...
//Filtre
  ...
  function Trieprix() {
    ...
    let liste=[Italie, Espagne, Angleterre, Mexique, Chine, Canada, Japon, EtatsUnis];
  ...
  function Triealpha() {
    ...
    let liste=[Angleterre, Canada, Chine, Espagne, EtatsUnis, Italie, Japon,Mexique];
